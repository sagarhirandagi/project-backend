...
public class DepartmentController {
	...
	public ResponseEntity<Department> getDepartById(@PathVariable Long deptId) {
	...
	public ResponseEntity<Department> updateDepartment(@PathVariable Long deptId, @RequestBody Department departmentDetails){
		Department department = departmentRepository.findById(deptId)
				.orElseThrow(() -> new ResourceNotFoundException("Department doesnot exist with id :" + deptId));
	...
	public ResponseEntity<Map<String, Boolean>> deleteEmployee(@PathVariable Long deptId){
		Department department = departmentRepository.findById(deptId)
				.orElseThrow(() -> new ResourceNotFoundException("Department not exist with id :" + deptId));
